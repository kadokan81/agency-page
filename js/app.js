 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper-dialog")) new core(".swiper-dialog", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        if (document.querySelector(".mix-section-container")) {
            console.log("ok");
            var mixer = mixitup(".mix-section-container", {
                animation: {
                    duration: 300
                }
            });
            console.log("mixer", mixer);
            mixer.filter(".create-page");
        }
        window["FLS"] = true;
        isWebp();
        menuInit();
